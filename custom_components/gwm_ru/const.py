...
ENDPOINT_VEHICLE_CAPABILITIES = "/app-api/api/v1.0/vehicle/findVehicleCapabilityItem"
ENDPOINT_REMOTE_HISTORY = "/app-api/api/v1.0/vehicle/getWeyVrcHistory"
ENDPOINT_COMPOUND_TEMPLATE_LIST = "/app-api/api/v1.0/vehicle/getCompoundCommandTemplateList"
ENDPOINT_COMPOUND_TEMPLATE_INFO = "/app-api/api/v1.0/vehicle/getCompoundCommandTemplateInfo"
